    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#0f172a', color: '#fff', padding: '20px', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      <div style={{ maxWidth: '500px', margin: '0 auto', textAlign: 'center' }}>
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    ...
                    <span style={{ fontWeight: 'bold', color: '#f8fafc' }}>
                      {item.nome || item.username || (typeof item.get === 'function' ? item.get('nome') : 'Jogador')}
                    </span>
                  </div>
        ...
        <button 
          ...
          style={{ width: '100%', backgroundColor: '#38bdf8', color: '#0f172a', border: 'none', padding: '14px', borderRadius: '10px', fontWeight: 'bold', fontSize: '1em', cursor: 'pointer', marginTop: '20px' }}
        >
